...
{
    public class EfSectorDal : EfEntityRepositoryBase<Sector, JobApplicationEvaluationContext>, ISectorDal
    {
        public EfSectorDal(JobApplicationEvaluationContext context) : base(context)
        {
        }
    }
}
