    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecourseStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recourses_RecourseStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "RecourseStatuses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_RecourseStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "RecourseStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
